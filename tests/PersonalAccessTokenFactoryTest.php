...
class PersonalAccessTokenFactoryTest extends TestCase
{
    ...
    public function test_access_token_can_be_created()
    {
        ...
        $factory = new ROMaster2\Passport\PersonalAccessTokenFactory($server, $clients, $tokens, $jwt);
        ...
        $this->assertInstanceOf('ROMaster2\Passport\PersonalAccessTokenResult', $result);
    }
}
...
class PersonalAccessTokenFactoryTestModelStub extends ROMaster2\Passport\Token
{
    public $id = 1;
    public $secret = 'something';
}
