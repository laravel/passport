...
class RefreshTokenRepository implements RefreshTokenRepositoryInterface
{
    ...
    {
        $this->database->table(config('passport.prefix').'refresh_tokens')->insert([
    ...
    {
        $this->database->table(config('passport.prefix').'refresh_tokens')
    ...
    {
        return $this->database->table(config('passport.prefix').'refresh_tokens')
